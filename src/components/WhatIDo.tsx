        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Secured 1st Prize in back-to-back consecutive weeks leading Team NEO. Competed in intensive 24-hour hackathons, prototyping and pitching solutions under pressure.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Active AWS Security User Group (APAC) contributor and Guest Speaker for Career Guidance. Official representative at Roar 2026, BITSoM's flagship event.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
